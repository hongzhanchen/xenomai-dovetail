			...
			const struct __user_old_itimerspec __user *src)
{
	...
	dst->it_interval.tv_sec = u_ts.it_interval.tv_sec;
	dst->it_interval.tv_nsec = u_ts.it_interval.tv_nsec;
	dst->it_value.tv_sec = u_ts.it_value.tv_sec;
	dst->it_value.tv_nsec = u_ts.it_value.tv_nsec;
	...
	const struct itimerspec64 *src)
{
	...
	u_ts.it_interval.tv_sec = src->it_interval.tv_sec;
	u_ts.it_interval.tv_nsec = src->it_interval.tv_nsec;
	u_ts.it_value.tv_sec = src->it_value.tv_sec;
	u_ts.it_value.tv_nsec = src->it_value.tv_nsec;
